...
################################################################################
## Form generated from reading UI file 'gap_measure.ui'
##
...
class Ui_gapMeasurement(object):
    def setupUi(self, gapMeasurement):
        if not gapMeasurement.objectName():
            gapMeasurement.setObjectName(u"gapMeasurement")
        gapMeasurement.resize(560, 350)
        gapMeasurement.setMinimumSize(QSize(560, 350))
        self.styleSheet = QWidget(gapMeasurement)
...
"")
        ...
        self.label.setGeometry(QRect(70, 37, 301, 41))
        self.gapLineEdit = QLineEdit(self.pagesContainer)
        self.gapLineEdit.setObjectName(u"gapLineEdit")
        self.gapLineEdit.setGeometry(QRect(20, 90, 501, 141))
        self.gapLineEdit.setStyleSheet(u"font: 72pt \"HY\uacac\uace0\ub515\";")
        self.gapLineEdit.setCursorPosition(5)
        self.gapLineEdit.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        ...
        gapMeasurement.setCentralWidget(self.styleSheet)

        self.retranslateUi(gapMeasurement)

        QMetaObject.connectSlotsByName(gapMeasurement)
    # setupUi

    def retranslateUi(self, gapMeasurement):
        gapMeasurement.setWindowTitle(QCoreApplication.translate("gapMeasurement", u"MainWindow", None))
        self.titleRightInfo.setText(QCoreApplication.translate("gapMeasurement", u"<html><head/><body><p><span style=\" font-size:11pt;\">Gap Measurement</span></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("gapMeasurement", u"Minimize", None))
#endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("gapMeasurement", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
